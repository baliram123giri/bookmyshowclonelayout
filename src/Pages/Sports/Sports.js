...
export const Sports = () => {
  return (
    <section className='b_sports'>
      <div className="b_top py-3">
        <div className="container">
          <div className='w-100'>
            <img src="1710310089327_miweb.avif" className='rounded-4 ' width={"100%"} alt="" />
          </div>
        </div>
      </div>
      <div className="b_bottom bg-light p-5">
